...
scaryStoryBtn.addEventListener("click", function () {displayStory("scary");});
funnyStoryBtn.addEventListener("click", function () {displayStory("funny");});
adventureStoryBtn.addEventListener("click", function () {displayStory("adventure");});